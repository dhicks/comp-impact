...
```{r sentiment-histograms, fig.cap = 'Kernel density estimates of length-normalized sentiment analysis scores.  Scores are on x-axis (note log scale), with densities on the y-axis. Vertical line indicates scores = 10 (1% of all article words). February 2000 is excluded from this plot. \\label{fig.sent_scores}'}
...
- inclusion/exclusion criteria
	- terms used for initial BNA search
	- exclusion of February 2000
- vocabulary normalization
	- what stopwords were removed
	- decision not to stem
- "toxcast" as starting point for analysis
- choice of distance function
- size of "associated terms" sets
- count-based analysis completely ignores structure and context
- choice of date threshold
- linear vs. non-linear trends
- choice of sentiment analysis tool
	- all of the assumptions and contingencies of this tool
- raw vs. article-length-normalized statistics
- level of aggregation (sentence, paragraph, article, month, quarter, year)
